...
1. [发行版的选择](./linux_distros.md)

2. [Linux的安装](./linux_install.md)

3. [常见发行版的系统结构](./linux_sys.md)

4. [桌面环境的选择](./linux_des.md)

5. [Linux初始化管理器](./linux_init.md)

6. [包管理器](./linux_pack_mgr.md)

7. [Linux 的Shell](./linux_shell.md)

7. [Linux的应用软件](./linux_apps.md)

8. [定制属于自己的Linux](./linux_customize.md)

9. [Linux与其他系统的对比](./linux_compare.md)
